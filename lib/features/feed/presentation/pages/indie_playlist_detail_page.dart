...
class IndiePlaylistDetailPage extends ConsumerStatefulWidget {
  final String playlistId;
  final bool useBuzzingPreset;

  const IndiePlaylistDetailPage({
    super.key,
  ...
  @override
  ConsumerState<IndiePlaylistDetailPage> createState() =>
      _IndiePlaylistDetailPageState();
}

class _IndiePlaylistDetailPageState
    extends ConsumerState<IndiePlaylistDetailPage> {
  _PlaylistMeta? _meta;
  ...
  static const _buzzingDescription =
      'Audio omakase based on what real Indie fans are connecting with. '
  ...
  Future<void> _fetchBuzzingGenreTracks() async {
    final responses = await Future.wait([
      dioClient.dio.get('/discovery/genre/${Uri.encodeComponent(_indieQuery)}'),
