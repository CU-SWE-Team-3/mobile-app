...
class FolkPlaylistDetailPage extends ConsumerStatefulWidget {
  final String playlistId;
  final bool useBuzzingPreset;

  const FolkPlaylistDetailPage({
    super.key,
  ...
  @override
  ConsumerState<FolkPlaylistDetailPage> createState() =>
      _FolkPlaylistDetailPageState();
}

class _FolkPlaylistDetailPageState
    extends ConsumerState<FolkPlaylistDetailPage> {
  _PlaylistMeta? _meta;
  ...
  static const _buzzingDescription =
      'Audio omakase based on what real Folk fans are connecting with. '
  ...
  Future<void> _fetchBuzzingGenreTracks() async {
    final responses = await Future.wait([
      dioClient.dio.get('/discovery/genre/${Uri.encodeComponent(_folkQuery)}'),
