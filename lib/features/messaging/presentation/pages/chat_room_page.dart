...
class _ChatRoomPageState extends ConsumerState<ChatRoomPage> {
  ...
  // Receiver ID cached from build() so the text-change listener can access it.
  String? _receiverId;
  ...
  // Edit mode: non-null means we're editing that message id
  ...
  void _onUserTyping(Map<String, dynamic> data) {
    ...
    // Safety-net: auto-hide after 3s in case stop event is missed.
  ...
  void _onTextChanged() {
    ...
    // Emit only once per typing session; the timer resets on every keystroke.
    if (!_isTypingEmitted) {
  ...
  void dispose() {
    ...
    _typingStopTimer?.cancel();
    _typingHideTimer?.cancel();
    // Emit stop_typing if we were mid-typing when the screen was dismissed.
  ...
  Widget build(BuildContext context) {
    ...
    // Cache receiver ID for the text-change listener.
                ...
                return RefreshIndicator(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, i) {
                      ...
                      // Context menu only for own, non-deleted, non-pending
                      // messages within the 15-minute edit window.
                      ...
                      return Opacity(
                        ...
                        child: MessageBubble(
                          ...
                          onEdit: canEditDelete ? () => _enterEditMode(msg) : null,
                          onDelete:
                  ...
                  children: [
                    ...
                    const Expanded(
                      child: Text(
                        'Editing message',
                        style: TextStyle(
                            color: Color(0xFFFF5500), fontSize: 12),
                      ),
                    ),
                    GestureDetector(
                      onTap: onCancelEdit,
